...
/* Logo embebido de El Amigo del Perro */
...
const buildOrderPayload = ({ orderId, customer, cart, shippingZone, shipCost, subtotal, grandTotal, recurringOrder, recurringDate }) => {
  ...
  return {
    ...
    cliente: {
      ...
      total: grandTotal,
      estado: "Pendiente",
      programacion: recurringOrder ? "Si" : "No",
      fechaProgramacion: recurringOrder && recurringDate ? recurringDate : "",
    },
  ...
  <style>{`
    ...
    *, *::before, *::after { box-sizing:border-box; margin:0; padding:0; }
    ...
    .recur-date-wrap {
      ...
      background:#fff; border-top:1px solid rgba(74,122,90,0.15);
      animation:fadeIn .2s ease;
    }
    .recur-date-lbl {
      font-family:var(--f-body); font-size:10px; font-weight:600;
      letter-spacing:.1em; text-transform:uppercase; color:#2D4A35;
    ...
    .amigo-banner {
      ...
      border:2px solid #8B1A1A; position:relative;
    }
    .amigo-banner-top {
      background:linear-gradient(125deg,#1a0a0a 0%,#6b1414 40%,#9b2020 70%,#c13030 100%);
      padding:16px 16px 14px; display:flex; align-items:center; gap:14px;
      position:relative; overflow:hidden;
    }
    /* decorative paw prints behind */
    .amigo-banner-top::before {
      content:"🐾 🐾 🐾";
      position:absolute; right:-6px; top:2px;
      font-size:32px; opacity:.07; letter-spacing:8px;
    ...
    .amigo-logo-ring img { width:100%; height:100%; object-fit:cover; }
              ...
              {orderCompleted ? (
                ...
                <>
                  ...
                  <div className="recur-section">
                    ...
                    >
                      ...
                      <div className="recur-label">
                        ...
                        <p className="recur-label-sub">Que tu mascota nunca se quede sin cuidado</p>
                      </div>
                      <button
                        type="button"
                    ...
                    {recurringOrder && (
                      <div className="recur-date-wrap">
                        ...
                        <input
                          ...
                          aria-label="Fecha del pedido recurrente mensual"
                        />
                        <p className="recur-date-hint">
                          Cada mes te contactaremos cerca de esta fecha para renovar tu pedido. Puedes cancelar cuando quieras.
                        </p>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="amigo-banner">
                    <div className="amigo-banner-top">
                      ...
                      <div className="amigo-texts">
                        ...
                        <p className="amigo-desc">
                          {recurringOrder
                            ? "¡Genial! Tu 15% de descuento en estaías cortas está listo."
                            : "Activa el pedido programado y desbloquea este beneficio."}
                        </p>
                      </div>
                    ...
                    <div className={`amigo-banner-bottom${recurringOrder ? " unlocked" : ""}`}>
                      {recurringOrder
                        ? "✅ Válido en estaías cortas · Se aplica al confirmar tu pedido programado"
                        : "🔒 Activa el plan arriba para desbloquear el 15% de descuento en la guardería"}
                    </div>
                  </div>
                </>
              )}
